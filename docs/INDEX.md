...
- `docs/adr/028-provider-neutral-stack-metadata.md` — shared `StackMetadata` + gh-stack as a second provider
- Key source: `git-workon-lib/src/stack.rs`, `git-workon-lib/src/stack/graphite.rs`, `git-workon-lib/src/stack/gh_stack.rs`, `git-workon-lib/src/config.rs` (`stack_model`, `stack_auto_track`)
