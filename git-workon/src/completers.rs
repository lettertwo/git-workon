...
/// ADR-030 only promises this delegation for the review binary, so the allowlist starts there.
...
/// `COMPLETE=<shell>` responder — the M6 CS3-deferred seam, wired here per ADR-030 CS5.
///
