//! The `theme = auto` terminal-derivation probe (ADR-029, CS6).
//!
...
//! red/green blended toward the probed background — the ADR-029 derived-washes addendum); only
...
/// synthesizing the six slots ANSI has no equivalent for (ADR-029). The diff-critical slots
