...
/// render time against the active [`crate::theme::Palette`] (ADR-029), NOT baked in here: the
...
/// `keyword`. This is the capture *index space* — theme-invariant (see ADR-029); the
