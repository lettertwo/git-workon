pub use crate::{
    ...
    predicates::{
        ...
        HasSqliteBranchMetadataPredicate, HasStagedDeletionPredicate, HasStagedFilePredicate,
        HasStashPredicate, HasUnstagedFilePredicate, HasUntrackedFilePredicate,
        HasUpstreamPredicate, HasWorktreePredicate, HeadCommitMessageContainsPredicate,
        HeadCommitParentCountPredicate, HeadMatchesPredicate, IndexBlobEqualsPredicate,
...
pub mod predicate {
    pub mod repo {
        pub use crate::predicates::{
            ...
            has_index_mode, has_metadata_parent_revision, has_no_stash, has_remote,
