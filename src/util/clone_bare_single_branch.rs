...
use crate::util::{get_default_branch_name, get_remote_callbacks};

pub fn clone_bare_single_branch(path: PathBuf, url: &str) -> Result<Repository> {
    ...
    // 1. git clone --bare --single-branch <url>.git .bare
